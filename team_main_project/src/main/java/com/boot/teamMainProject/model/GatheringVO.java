...
public class GatheringVO {
	...
	public String getGatArea() {
		return gatArea;
	}
	public void setGatArea(String gatArea) {
		this.gatArea = gatArea;
	}
	public Date getGatOpen() {
		return gatOpen;
	}
	...
	public String getGatBanPhoto() {
		return gatBanPhoto;
	}
	public void setGatBanPhoto(String gatBanPhoto) {
		this.gatBanPhoto = gatBanPhoto;
	}
