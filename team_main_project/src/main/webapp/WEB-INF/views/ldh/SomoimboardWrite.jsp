	...
	<body>
		...
		<div class="wrap">
			<form id="SBoardForm" name="SBoardForm" method="post"  action="/sboard">
				...
				style="width:1000px; height:40px" placeholder="제목을 입력해주세요" 
...
<!-- 				<input type="text" id="gatDetInfo" name="gatDetInfo" style="text-align: top; width:510px; height:537px"> -->
				<tr><td colspan="3"><textarea id="gatDetInfo" name="gatDetInfo" rows="15" cols="141" placeholder="내용을 입력해주세요" onfocus="this.placeholder=''" onblur="this.placeholder='내용을 입력해주세요'"></textarea>
				</td></tr>
