				...
				<section id="moimsearch">
					...
					<div class="resultmoim">
						<div class="cardbox moimcard">
							<!-- 받아오기 -->
							<c:forEach items="${gatheringResult}" begin="0" end="3" var="gat" >
								<div class="card">
						...
						<div class="cardbox moimcard">
							<c:forEach items="${gatheringResult}" begin="4" end="7" var="gat" >
								<div class="card">
									<img src="<c:url value='/images/${gat.gatPhoto}'/>" alt="LOGO">
									<div class="cardbody">
										<h5 class="cardtitle">${gat.gatName}</h5>
						...
						<div class="cardbox moimcard">
							<c:forEach items="${gatheringResult}" begin="8" end="11" var="gat" >
								<div class="card">
									<img src="<c:url value='/images/${gat.gatPhoto}'/>" alt="LOGO">
									<div class="cardbody">
										<h5 class="cardtitle">${gat.gatName}</h5>
